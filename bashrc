...
export ANT_HOME=~/dev-tools/apache-ant-1.8.1
export PATH=$PATH:$ANT_HOME/bin:$MAVEN_HOME/bin:$GEM_HOME/bin:~/local/bin:~/dev-libs/appengine-java-sdk-1.2.0/bin:$ORACLE_HOME/bin:/opt/tools/tora
